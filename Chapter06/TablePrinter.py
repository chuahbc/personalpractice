...
tableData = [['apples', 'oranges', 'cherries', 'banana', 'watermelon'],
             ...
             ['dogs', 'cats', 'moose', 'goose', 'chicken'],
             ['socks', 'shoes', 'shirt', 'pants','necktie']]
...
# number of 0 values as the number of inner lists in tableData. That way, colWidths[0] can store the width of the longest 
